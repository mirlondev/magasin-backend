...
import org.odema.posnew.application.dto.response.RefundItemResponse;
...
public class RefundMapper {
    ...
    public RefundResponse toResponse(Refund refund) {
        ...
        return new RefundResponse(
                ...
                mapItems(refund.getItems()),
                refund.getItems() != null ? refund.getItems().size() : 0,
    ...
    private List<RefundItemResponse> mapItems(List<RefundItem> items) {
    ...
    private RefundItemResponse toItemResponse(RefundItem item) {
