...
public class PaymentController {
    ...
    public ResponseEntity<ApiResponse<PaymentResponse>> createCreditPayment(
        ...
        PaymentResponse response = paymentService.createCreditPayment(
                orderId,
                request,
                userDetails.getUserId()
        );
    ...
    public ResponseEntity<ApiResponse<BigDecimal>> getOrderTotalPaid(
            @PathVariable UUID orderId) {
    ...
    public ResponseEntity<ApiResponse<BigDecimal>> getOrderCreditAmount(
            @PathVariable UUID orderId) {
    ...
    public ResponseEntity<ApiResponse<BigDecimal>> getOrderRemainingAmount(
            @PathVariable UUID orderId) {
